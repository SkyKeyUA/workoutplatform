(() => {
    ...
    let userIcon = document.querySelector(".responsive__body");
    let userMenu = document.querySelector(".responsive__title");
    userIcon.addEventListener("click", (function(e) {
        userMenu.classList.toggle("open-active");
    }));
    document.documentElement.addEventListener("click", (function(e) {
        if (!e.target.closest(".responsive__title")) userMenu.classList.remove("open-active");
    }));
    document.addEventListener("keyup", (function(e) {
        if ("Escape" === e.code) userMenu.classList.remove("_active");
    }));
    ...
    if (animItems.length > 0) {
        ...
        function animOnScroll(params) {
            for (let index = 0; index < animItems.length; index++) {
                ...
                if (pageYOffset > animItemOffset - animItemPoint && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_active"); else animItem.classList.remove("_active");
            }
        }
        function offset(el) {
